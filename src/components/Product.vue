<template>
<div class="rounded-lg flex-1 h-full flex flex-col relative  p-3 md:p-2">
  <router-link :to="'/product/' + id">
    <img class="mx-auto w-full p-4 bg-[#f2f0ea] object-cover rounded-[30px]" :src="Array.isArray(imageUrl) ? imageUrl[0] : imageUrl" alt="" />
  </router-link>
  <button @click="toggleFavourite" type="button" class=" rounded-full  absolute top-4 right-4">
...
const toggleFavourite = () => {
  ...
  favouriteStore.getAddFavPro(product);
};
</script>
